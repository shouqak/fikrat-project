  ...
  useEffect(() => {
    const fetchTeachers = async () => {
      try {
        ...
        setError('فشل في تحميل قائمة المعلمين');
        setLoading(false);
            ...
            <form onSubmit={handleSubmit} className="p-4 md:p-5 text-right">
              ...
              <div className="mb-4">
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full p-3 border bg-white border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent  "
                  required
                >
